...
! function(t) {
    ...
    t.formatter = {
        ...
        parse: function(t) {
            var r = EncyrptionJS.lib.CipherParams.create({}),
                e = this.prefix.length;
            return 0 !== t.indexOf(this.prefix) ? r : (r.ciphertext = EncyrptionJS.enc.Hex.parse(t.substring(16 + e)), r.salt = EncyrptionJS.enc.Hex.parse(t.substring(e, 16 + e)), r)
        }
    }, t.encrypt = function(r, e) { try { return EncyrptionJS.AES.encrypt(r, e, { format: t.formatter }).toString() } catch (n) { return "" } }, t.decrypt = function(r, e) { try { var n = EncyrptionJS.AES.decrypt(r, e, { format: t.formatter }); return n.toString(EncyrptionJS.enc.Utf8) } catch (i) { return "" } }
}(AdvanceEncyrptionJS);
...
function GetJSONFeed(datajson,decodedString) {
    ...
    var BindingElement = "";
    var ElementRes = "";
    var str1 = decodedString;
    var str2 = new Array();

    var JSONfeed = datajson.feed.openSearch$totalResults.$t;
    for (var i = 0; i < JSONfeed; i++) {
        var FEEDpost;
        for (var s = 0; s < datajson.feed.entry[i].link.length; s++) {
            if (datajson.feed.entry[i].link[s].rel == 'alternate') {
                FEEDpost = datajson.feed.entry[i].link[s].href;
                break;
            }
        }
        str2[i] = FEEDpost;
        var MathRandom = Math.random() * str2.length;
        MathRandom = parseInt(MathRandom);
    }
    for (var i = 0; i < str1.length; i++) {
        check = false;
        no = 0;
        while (check == false && no < exceptionlength) {
            BindingElement = GetDomUri(str1[i].href);
            ElementRes = GetDomUri(exception[no]);
            if (BindingElement.match(ElementRes)) {
                check = true;
            }
            no++;
        }
        if (check == false) {
            str1[i].href = str2[MathRandom] + setting.path + AdvanceEncyrptionJS.encrypt(ConvertToString(str1[i].href), ConvertToString('root'));
            str1[i].rel = "nofollow";
            str1[i].target = "_blank";
        }
    }
}
var EncyrptionJS = EncyrptionJS || function(t, e) {
    var r = {},
        n = r.lib = {},
        i = n.Base = function() {
            function t() {}
            return {
                extend: function(e) { t.prototype = this; var r = new t; return e && r.mixIn(e), r.hasOwnProperty("init") || (r.init = function() { r.$super.init.apply(this, arguments) }), r.init.prototype = r, r.$super = this, r },
        ...
        o = n.WordArray = i.extend({
            init: function(t, r) { t = this.words = t || [], this.sigBytes = r != e ? r : 4 * t.length },
            toString: function(t) { return (t || a).stringify(this) },
            concat: function(t) {
                var e = this.words,
                    r = t.words,
                    n = this.sigBytes,
            ...
            random: function(e) { for (var r = [], n = 0; e > n; n += 4) r.push(4294967296 * t.random() | 0); return new o.init(r, e) }
        }),
        s = r.enc = {},
        a = s.Hex = {
            ...
            parse: function(t) { for (var e = t.length, r = [], n = 0; e > n; n += 2) r[n >>> 3] |= parseInt(t.substr(n, 2), 16) << 24 - n % 8 * 4; return new o.init(r, e / 2) }
        },
        c = s.Latin1 = {
            stringify: function(t) {
                for (var e = t.words, r = t.sigBytes, n = [], i = 0; r > i; i++) {
            ...
            parse: function(t) { for (var e = t.length, r = [], n = 0; e > n; n++) r[n >>> 2] |= (255 & t.charCodeAt(n)) << 24 - n % 4 * 8; return new o.init(r, e) }
        },
        f = s.Utf8 = { stringify: function(t) { try { return decodeURIComponent(escape(c.stringify(t))) } catch (e) { throw new Error("Malformed UTF-8 data") } }, parse: function(t) { return c.parse(unescape(encodeURIComponent(t))) } },
        ...
        h = (n.Hasher = u.extend({ cfg: i.extend(), init: function(t) { this.cfg = this.cfg.extend(t), this.reset() }, reset: function() { u.reset.call(this), this._doReset() }, update: function(t) { return this._append(t), this._process(), this }, finalize: function(t) { t && this._append(t); var e = this._doFinalize(); return e }, blockSize: 16, _createHelper: function(t) { return function(e, r) { return new t.init(r).finalize(e) } }, _createHmacHelper: function(t) { return function(e, r) { return new h.HMAC.init(t, r).finalize(e) } } }), r.algo = {});
    return r
}(Math);
! function() {
    {
        ...
        n.Base64 = {
            ...
            parse: function(t) {
                var e = t.length,
                    n = this._map,
                    i = n.charAt(64);
                if (i) { var o = t.indexOf(i); - 1 != o && (e = o) }
...
function(t) {
    function e(t, e, r, n, i, o, s) { var a = t + (e & r | ~e & n) + i + s; return (a << o | a >>> 32 - o) + e }

    function r(t, e, r, n, i, o, s) { var a = t + (e & n | r & ~n) + i + s; return (a << o | a >>> 32 - o) + e }
    ...
    var o = EncyrptionJS,
        ...
        f = o.algo,
        u = [];
    ! function() { for (var e = 0; 64 > e; e++) u[e] = 4294967296 * t.abs(t.sin(e + 1)) | 0 }();
    var h = f.MD5 = c.extend({
        _doReset: function() { this._hash = new a.init([1732584193, 4023233417, 2562383102, 271733878]) },
        ...
        clone: function() { var t = c.clone.call(this); return t._hash = this._hash.clone(), t }
    });
...
}(), EncyrptionJS.lib.Cipher || function(t) {
        var e = EncyrptionJS,
            r = e.lib,
            n = r.Base,
            i = r.WordArray,
            ...
            u = r.Cipher = o.extend({
                ...
                init: function(t, e, r) { this.cfg = this.cfg.extend(r), this._xformMode = t, this._key = e, this.reset() },
                reset: function() { o.reset.call(this), this._doReset() },
            ...
            p = r.BlockCipherMode = n.extend({ createEncryptor: function(t, e) { return this.Encryptor.create(t, e) }, createDecryptor: function(t, e) { return this.Decryptor.create(t, e) }, init: function(t, e) { this._cipher = t, this._iv = e } }),
            l = h.CBC = function() {
                function e(e, r, n) {
                    var i = this._iv;
                    if (i) {
            ...
            y = (r.BlockCipher = u.extend({
                cfg: u.cfg.extend({ mode: l, padding: v }),
                reset: function() {
                    u.reset.call(this);
                    var t = this.cfg,
                        e = t.iv,
                ...
                blockSize: 4
            }), r.CipherParams = n.extend({ init: function(t) { this.mixIn(t) }, toString: function(t) { return (t || this.formatter).stringify(this) } })),
            g = e.format = {},
            _ = g.OpenSSL = {
                stringify: function(t) {
                    var e = t.ciphertext,
            ...
            B = S.OpenSSL = {
                execute: function(t, e, r, n) {
                    n || (n = i.random(8));
                    var o = f.create({ keySize: e + r }).compute(t, n),
                        s = i.create(o.words.slice(e), 4 * r);
                    return o.sigBytes = 4 * e, y.create({ key: o, iv: s, salt: n })
                }
            },
    ...
    function() {
        ...
        var d = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
            v = n.AES = r.extend({
                    ...
                    encryptBlock: function(t, e) { this._doCryptBlock(t, e, this._keySchedule, s, a, c, f, i) },
